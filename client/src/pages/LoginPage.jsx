...
function InputField({ icon: Icon, type = 'text', placeholder, value, onChange, rightSlot }) {
    return (
        <div className="relative flex items-center">
            ...
            <input
                ...
                value={value}
                onChange={onChange}
                className="w-full pl-10 pr-10 py-3 rounded-xl bg-white/50 border border-white/70 text-[13px] font-medium text-slate-800 placeholder-slate-400 outline-none focus:ring-2 focus:ring-[#007AFF]/30 focus:border-[#007AFF]/50 transition-all"
            />
            {rightSlot && (
            ...
            <div className="w-full max-w-[420px] bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[32px] shadow-[0_8px_40px_rgba(120,80,200,0.10)] p-8 z-10 space-y-6">
                ...
                {tab === 'signin' && (
                    <div className="space-y-3">
                        ...
                        <button className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#007AFF] text-white text-[13px] font-bold shadow-[0_4px_14px_rgba(0,122,255,0.30)] hover:bg-[#0066DD] transition-colors">
